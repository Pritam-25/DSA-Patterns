...
class Solution {
   ...
   public:
    int minInsertions(string s) {
        ...
        int longestPalindromeSubseq = dfs(s, s2, 0, 0, dp);

        // the minimum insertions required to make the string palindrome is the difference between the length of the string and the length of the longest palindromic subsequence
